...
### Moiety A ($T_1=3s, T_2=1s$)
![DRCMR Simulator Validation - Moiety A](validation/moiety A validation.png)

### Moiety B ($T_1=1.5s, T_2=0.1s$)
![DRCMR Simulator Validation - Moiety B](validation/moiety B validation.png)
